...
def process_dns_lookup(line):
    ...
    # Did sanity check IP address, get name
    ip=line
    lookup='IP'
    try:
        #result='quick answer'
        ...
        print('Exception caught: ', exception, ' IP: ', ip)
        # item will be None if get here
        pass
...
def do_dns_lookups(initial_filename):
    ...
    """
    # For real use, I'd read the IP's from a file probably... 
